...
for i in np.arange(1980, 2023):
    ...
    yeartemp_MAM = np.hstack((yeartemp_mar, yeartemp_apr, yeartemp_may))
    if i == 1980:
        sam_MAM = np.nanmean(yeartemp_MAM)
    else:
        sam_MAM = np.hstack((sam_MAM, np.nanmean(yeartemp_MAM)))        

# Calculative cumulative for each season
sam_JJA_cumulative = sam_JJA.cumsum()
sam_SON_cumulative = sam_SON.cumsum()
sam_DJF_cumulative = sam_DJF.cumsum()
sam_MAM_cumulative = sam_MAM.cumsum()
sam_yearly = sam_pd_yearly.values[1:-1]
#%% Calculate trends
stats.linregress(np.arange(1980, 2023), sam_pd_yearly.values[1:-1]) # ***
stats.linregress(np.arange(1980, 2023), sam_JJA)
stats.linregress(np.arange(1980, 2023), sam_SON)
stats.linregress(np.arange(1980, 2023), sam_DJF) # ***
stats.linregress(np.arange(1980, 2023), sam_MAM) # **
#%% Load El Niño
...
# Calculative cumulative for each season
mei_JJA_cumulative = mei_JJA.cumsum()
mei_SON_cumulative = mei_SON.cumsum()
mei_DJF_cumulative = mei_DJF.cumsum()
mei_MAM_cumulative = mei_MAM.cumsum()
mei_yearly_cumulative = mei_yearly.cumsum()
plt.plot(np.arange(1980, 2023), mei_yearly_cumulative)
#%% Calculate trends
stats.linregress(np.arange(1980, 2023), mei_yearly) # ***
stats.linregress(np.arange(1980, 2023), mei_JJA) # **
stats.linregress(np.arange(1980, 2023), mei_SON) # *
stats.linregress(np.arange(1980, 2023), mei_DJF)
stats.linregress(np.arange(1980, 2023), mei_MAM) # **
#%% Plot
fig, axs = plt.subplots(5, 2, figsize=(6,9))
# Yearly SAM
axs[0,0].scatter(np.arange(1980, 2023), sam_yearly, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), sam_yearly)
axs[0,0].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[0,0].set_ylim(-1.5, 1.5)
# JJA SAM
axs[1,0].scatter(np.arange(1980, 2023), sam_JJA, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), sam_JJA)
axs[1,0].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='k', linewidth=2)
axs[1,0].set_ylim(-1.5, 1.5)
# SON SAM
axs[2,0].scatter(np.arange(1980, 2023), sam_SON, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), sam_SON)
axs[2,0].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='k', linewidth=2)
axs[2,0].set_ylim(-1.5, 1.5)
# DJF SAM
axs[3,0].scatter(np.arange(1980, 2023), sam_DJF, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), sam_DJF)
axs[3,0].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[3,0].set_ylim(-1.5, 1.5)
# MAM SAM
axs[4,0].scatter(np.arange(1980, 2023), sam_MAM, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), sam_MAM)
axs[4,0].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[4,0].set_ylim(-1.5, 1.5)
# Yearly MEI
axs[0,1].scatter(np.arange(1980, 2023), mei_yearly, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), mei_yearly)
axs[0,1].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[0,1].set_ylim(-3, 3)
# JJA MEI
axs[1,1].scatter(np.arange(1980, 2023), mei_JJA, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), mei_JJA)
axs[1,1].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[1,1].set_ylim(-3, 3)
# SON MEI
axs[2,1].scatter(np.arange(1980, 2023), mei_SON, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), mei_SON)
axs[2,1].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='k', linewidth=2)
axs[2,1].set_ylim(-3, 3)
# DJF MEI
axs[3,1].scatter(np.arange(1980, 2023), mei_DJF, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), mei_DJF)
axs[3,1].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='k', linewidth=2)
axs[3,1].set_ylim(-3, 3)
# MAM MEI
axs[4,1].scatter(np.arange(1980, 2023), mei_MAM, c='k', alpha=0.8, edgecolor='w')
slope, intercept, _, pval, _ = stats.linregress(np.arange(1980, 2023), mei_MAM)
axs[4,1].plot(np.arange(1980, 2023), np.arange(1980, 2023)*slope+intercept, c='#da2b39', linewidth=2)
axs[4,1].set_ylim(-3, 3)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\SupFig3_SAMandMEI.png'
...
axs.bar(np.arange(1,44)[sam_JJA<0], sam_JJA[sam_JJA<0], facecolor='b', alpha=0.7)
axs.bar(np.arange(1,44)[sam_JJA>0], sam_JJA[sam_JJA>0], facecolor='r', alpha=0.7)
axs.axhline(c='k', linewidth=1, alpha=1, linestyle='-')
axs.set_ylim(-2,2)
axs.set_xlim(.25, 43.75)
plt.xticks(ticks=[1, 6, 11, 16, 21, 26, 31, 36, 41],
           labels=['1980', '1985', '1990', '1995', '2000', '2005', '2010', '2015', '2020'])
axs2 = axs.twinx()
axs2.plot(np.arange(1,44), sam_JJA_cumulative, 'k', linewidth=2, alpha=0.7, label='Cumulative SAM')
axs2.set_ylim(-3,3)
axs.set_ylabel('SAM index', fontsize=14)
axs2.set_ylabel('Cumulative SAM', fontsize=14)
plt.legend(loc=2, fontsize=12)
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\sam\\')
graphs_dir = 'SAM_JJA_Fig6.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Plot SON   
fig, axs = plt.subplots(1, 1, figsize=(10,2))
axs.bar(np.arange(1,44)[sam_SON<0], sam_SON[sam_SON<0], facecolor='b', alpha=0.7)
axs.bar(np.arange(1,44)[sam_SON>0], sam_SON[sam_SON>0], facecolor='r', alpha=0.7)
axs.axhline(c='k', linewidth=1, alpha=1, linestyle='-')
...
plt.xticks(ticks=[1, 6, 11, 16, 21, 26, 31, 36, 41],
           labels=['1980', '1985', '1990', '1995', '2000', '2005', '2010', '2015', '2020'])
axs2 = axs.twinx()
axs2.plot(np.arange(1,44), sam_SON_cumulative, 'k', linewidth=2, alpha=0.7, label='Cumulative SAM SON')
axs2.set_ylim(-3,3)
axs.set_ylabel('SAM index', fontsize=14)
axs2.set_ylabel('Cumulative SAM', fontsize=14)
#plt.legend(loc=2)
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\sam\\')
graphs_dir = 'SAM_SON_Fig6.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Plot DJF   
fig, axs = plt.subplots(1, 1, figsize=(10,2))
axs.bar(np.arange(1,44)[sam_DJF<0], sam_DJF[sam_DJF<0], facecolor='b', alpha=0.7)
axs.bar(np.arange(1,44)[sam_DJF>0], sam_DJF[sam_DJF>0], facecolor='r', alpha=0.7)
axs.axhline(c='k', linewidth=1, alpha=1, linestyle='-')
axs.set_ylim(-1.5,1.5)
axs.set_xlim(.25, 43.75)
plt.xticks(ticks=[1, 6, 11, 16, 21, 26, 31, 36, 41],
           labels=['1980', '1985', '1990', '1995', '2000', '2005', '2010', '2015', '2020'])
axs2 = axs.twinx()
axs2.plot(np.arange(1,44), sam_DJF_cumulative, 'k', linewidth=2, alpha=0.7, label='Cumulative SAM DJF')
axs2.set_ylim(-10,10)
axs.set_ylabel('SAM index', fontsize=14)
axs2.set_ylabel('Cumulative SAM', fontsize=14)
#plt.legend(loc=2)
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\sam\\')
graphs_dir = 'SAM_DJF_Fig6.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Plot MAM   
fig, axs = plt.subplots(1, 1, figsize=(10,2))
axs.bar(np.arange(1,44)[sam_MAM<0], sam_MAM[sam_MAM<0], facecolor='b', alpha=0.7)
axs.bar(np.arange(1,44)[sam_MAM>0], sam_MAM[sam_MAM>0], facecolor='r', alpha=0.7)
axs.axhline(c='k', linewidth=1, alpha=1, linestyle='-')
axs.set_ylim(-1.5,1.5)
axs.set_xlim(.25, 43.75)
plt.xticks(ticks=[1, 6, 11, 16, 21, 26, 31, 36, 41],
           labels=['1980', '1985', '1990', '1995', '2000', '2005', '2010', '2015', '2020'])
axs2 = axs.twinx()
axs2.plot(np.arange(1,44), sam_MAM_cumulative, 'k', linewidth=2, alpha=0.7, label='Cumulative SAM MAM')
axs2.set_ylim(-5,5)
axs.set_ylabel('SAM index', fontsize=14)
axs2.set_ylabel('Cumulative SAM', fontsize=14)
#plt.legend(loc=2)
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\sam\\')
graphs_dir = 'SAM_MAM_Fig6.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%%
...
#%%
axs.plot(np.arange(1,44), sam_JJA, 'gray', linewidth=2, alpha=0.4, label='Monthly SAM')
...
axs.plot(np.arange(529), sam_monthly_movingmean, 'k', linewidth=1.5, alpha=1, label='SAM Mov. Mean')
axs.set_ylim(-3, 3)
axs2 = axs.twinx()
axs2.plot(np.arange(529), sam_pd_monthly_cumsum.values, c='r', linewidth=2, alpha=0.7, label='Cumulative SAM')
plt.xlim(11,529)
axs2.set_ylim(-40,40)
axs.plot(np.arange(529)[336:], np.arange(529)[336:]*slope + intercept, linestyle='--', c='k', label='2007-2022 Trend')
plt.xticks(ticks=[12, 72, 132, 192, 252, 312, 372, 432, 492], labels=['1980', '1985', '1990', '1995', '2000',
                                              '2005', '2010', '2015', '2020'])
fig.legend(loc="upper right", bbox_to_anchor=(1,1.151), bbox_transform=axs.transAxes, ncol=4, fontsize=10)
axs.set_ylabel('SAM index', fontsize=14)
axs2.set_ylabel('Cumulative SAM', fontsize=14)
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\sam\\')
graphs_dir = 'SAM_monthly_Fig6.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()  
