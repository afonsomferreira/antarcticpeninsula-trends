...
#%% Trends
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_b_init)], weds_b_init[~np.isnan(weds_b_init)]) 
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_b_term)], weds_b_term[~np.isnan(weds_b_term)]) 
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_b_peak)], weds_b_peak[~np.isnan(weds_b_peak)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_chlmax)], weds_chlmax[~np.isnan(weds_chlmax)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_b_dur)], weds_b_dur[~np.isnan(weds_b_dur)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_b_magnitude)], weds_b_magnitude[~np.isnan(weds_b_magnitude)])
...
#%% Trends
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_b_init)], ges_b_init[~np.isnan(ges_b_init)]) 
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_b_term)], ges_b_term[~np.isnan(ges_b_term)]) # **
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_b_peak)], ges_b_peak[~np.isnan(ges_b_peak)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_chlmax)], ges_chlmax[~np.isnan(ges_chlmax)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_b_dur)], ges_b_dur[~np.isnan(ges_b_dur)]) # *
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_b_magnitude)], ges_b_magnitude[~np.isnan(ges_b_magnitude)])
...
#%% Trends
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_b_init)], dra_b_init[~np.isnan(dra_b_init)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_b_term)], dra_b_term[~np.isnan(dra_b_term)]) # ***
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_b_peak)], dra_b_peak[~np.isnan(dra_b_peak)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_chlmax)], dra_chlmax[~np.isnan(dra_chlmax)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_b_dur)], dra_b_dur[~np.isnan(dra_b_dur)]) # ***
stats.linregress(np.arange(1998, 2023)[~np.isnan(dra_b_magnitude)], dra_b_magnitude[~np.isnan(dra_b_magnitude)])
...
#%% Trends
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_b_init)], brs_b_init[~np.isnan(brs_b_init)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_b_term)], brs_b_term[~np.isnan(brs_b_term)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_b_peak)], brs_b_peak[~np.isnan(brs_b_peak)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_chlmax)], brs_chlmax[~np.isnan(brs_chlmax)]) # **
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_b_dur)], brs_b_dur[~np.isnan(brs_b_dur)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(brs_b_magnitude)], brs_b_magnitude[~np.isnan(brs_b_magnitude)]) # *
...
#%% Trends
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_b_init)], wedn_b_init[~np.isnan(wedn_b_init)]) # **
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_b_term)], wedn_b_term[~np.isnan(wedn_b_term)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_b_peak)], wedn_b_peak[~np.isnan(wedn_b_peak)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_chlmax)], wedn_chlmax[~np.isnan(wedn_chlmax)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_b_dur)], wedn_b_dur[~np.isnan(wedn_b_dur)]) # ***
stats.linregress(np.arange(1998, 2023)[~np.isnan(wedn_b_magnitude)], wedn_b_magnitude[~np.isnan(wedn_b_magnitude)]) #**
#%%
