...
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\chl\\roi\\bransfield_seasonalcycle.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
### Gerlache Strait
x, y = np.meshgrid(lon, lat) # make a canvas with coordinates
...
plt.legend(fontsize=16)
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\chl\\roi\\gerlache_seasonalcycle.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
### Elephant Island
x, y = np.meshgrid(lon, lat) # make a canvas with coordinates
...
plt.legend(fontsize=16)
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\chl\\roi\\elephant_seasonalcycle.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
### Drake Strait
x, y = np.meshgrid(lon, lat) # make a canvas with coordinates
...
plt.legend(fontsize=16)
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\chl\\roi\\drake_seasonalcycle.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
### Weddell Sea
x, y = np.meshgrid(lon, lat) # make a canvas with coordinates
...
plt.legend(fontsize=16)
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\chl\\roi\\weddell_seasonalcycle.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
##