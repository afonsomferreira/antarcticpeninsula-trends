...
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_sepnov)], weds_sepnov[~np.isnan(weds_sepnov)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(weds_marapr)], weds_marapr[~np.isnan(weds_marapr)]) # *
...
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_sepnov)], ges_sepnov[~np.isnan(ges_sepnov)])
stats.linregress(np.arange(1998, 2023)[~np.isnan(ges_marapr)], ges_marapr[~np.isnan(ges_marapr)]) # ***
