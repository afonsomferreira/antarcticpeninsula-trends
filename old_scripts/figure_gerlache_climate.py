...
#        par_summerstds19982021 = np.hstack((par_summerstds19982021, yeartemp_summerstd))
#%% Dec-Feb Mean from 1981 to 2021
...
#    yeartemp_mar = sst_gerlache_19812021[(time_date_years == i) & (time_date_months == 3)]
#    yeartemp_apr = sst_gerlache_19812021[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_summermean = np.nanmean(np.hstack((yeartemp_dec, yeartemp_jan,yeartemp_feb
                                                )))
#    yeartemp_summerstd = np.nanstd(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
#                                                )))    
    if i == 1982:
        sst_decfeb19812021 = yeartemp_summermean
#        sst_summerstds19982021 = yeartemp_summerstd
    else:
        sst_decfeb19812021 = np.hstack((sst_decfeb19812021, yeartemp_summermean))
#        sst_summerstds19982021 = np.hstack((sst_summerstds19982021, yeartemp_summerstd))
# SST
fig, axs = plt.subplots(1, 1, figsize=(11,2))
## Plot the actual values
#axs[1].scatter(dataframe_all_original.index, dataframe_all_original['Recruitment'].values, marker='^', c='#000080', label = 'Observed recruitment')
axs.scatter(np.arange(1982,2022), sst_decfeb19812021, marker='o', c='r', label = 'SST', s=50, alpha=.5, zorder=10)
[slope,intercept,r_val,p_val,_] = stats.linregress(np.arange(1982, 2022)[~np.isnan(sst_decfeb19812021)], sst_decfeb19812021[~np.isnan(sst_decfeb19812021)])
axs.plot(np.arange(1982,2022), np.arange(1982,2022)*slope+intercept, c='r', label = 'Sep 81-21', linestyle='--')
#[slope,intercept,r_val,p_val,_] = stats.linregress(np.arange(1990, 2011)[~np.isnan(sst_decfeb19812021[:21])], sst_decfeb19812021[:21][~np.isnan(sst_decfeb19812021[:21])])
#axs.plot(np.arange(1990,2011), np.arange(1990,2011)*slope+intercept, c='b', label = 'Sep 81-05', linestyle='--', marker='s', alpha=.5)
#[slope,intercept,r_val,p_val,_] = stats.linregress(np.arange(2006, 2022)[~np.isnan(sst_decfeb19812021[24:])], sst_decfeb19812021[24:][~np.isnan(sst_decfeb19812021[24:])])
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_decfeb_sst_19822022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_sepapr_SAM_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Wind Speed
# Define region of interest to average
gerlache_winds_verts = [(-65, -64.5),
             (-65, -63),
             (-52.5, -60),
             (-52.5, -61.6)]
#plt.figure()
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_sepapr_windspeed_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
fig, axs = plt.subplots(1, 1, figsize=(11,2))
# Wind Direction
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_sepapr_winddir_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_marapr_windspeed_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
fig, axs = plt.subplots(1, 1, figsize=(11,2))
# Wind Direction
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_marapr_winddir_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_sep_windspeed_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
fig, axs = plt.subplots(1, 1, figsize=(11,2))
# Wind Direction
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\figures_tentative\\')
graphs_dir = 'gerlache_sep_winddir_19802022.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
for i in np.arange(1983, 1997): #
    yeartemp_sep = sst_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = sst_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = sst_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = sst_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = sst_gerlache_19811996[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = sst_gerlache_19811996[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = sst_gerlache_19811996[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = sst_gerlache_19811996[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_summermean = np.nanmean(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
                                                yeartemp_jan, yeartemp_feb, yeartemp_mar,
                                                yeartemp_apr)))
    yeartemp_summerstd = np.nanstd(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
...
for i in range(0, len(time_date_seaice_19812021)):
    ...
    time_date_days[i] = time_date_seaice_19812021[i].day
for i in np.arange(1983, 2022): #
    yeartemp_sep = seaice_gerlache_19812021[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = seaice_gerlache_19812021[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = seaice_gerlache_19812021[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = seaice_gerlache_19812021[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = seaice_gerlache_19812021[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = seaice_gerlache_19812021[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = seaice_gerlache_19812021[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = seaice_gerlache_19812021[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_summermean = np.nanmean(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
                                                yeartemp_jan, yeartemp_feb, yeartemp_mar,
                                                yeartemp_apr)))
    yeartemp_summerstd = np.nanstd(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
...
for i in range(0, len(time_date_19811996)):
    ...
    time_date_months[i] = time_date_19811996[i].month
for i in np.arange(1983, 1997): #
    yeartemp_sep = seaice_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = seaice_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = seaice_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = seaice_gerlache_19811996[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = seaice_gerlache_19811996[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = seaice_gerlache_19811996[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = seaice_gerlache_19811996[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = seaice_gerlache_19811996[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_summermean = np.nanmean(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
                                                yeartemp_jan, yeartemp_feb, yeartemp_mar,
                                                yeartemp_apr)))
    yeartemp_summerstd = np.nanstd(np.hstack((yeartemp_sep, yeartemp_nov, yeartemp_dec,
...
for i in np.arange(1998, 2022):
    ...
    seaicetemp = seaice_gerlache[february15_prevyear_ind:february15_follyear_ind]
...
dataframe_gerlache = pd.DataFrame(data=chl_summermeans19982021[:-2], index=np.arange(1998,2020), columns=['Chla Mean'])
#dataframe_gerlache['Chla STD'] = chl_summerstds19982021[:-2]
dataframe_gerlache['SST Mean'] = sst_summermeans19982021[:-2]
#dataframe_gerlache['SST STD'] = sst_summerstds19982021[:-2]
dataframe_gerlache['SEAICE Mean'] = seaice_summermeans19982021[:-2]
#dataframe_gerlache['SEAICE STD'] = seaice_summerstds19982021[:-2]
dataframe_gerlache['PAR Mean'] = par_summermeans19982021[:-2]
#dataframe_gerlache['PAR STD'] = par_summerstds19982021[:-2]
dataframe_gerlache['SEAICE ADV SAT'] = seaice_advance19982021[:-2]
dataframe_gerlache['SEAICE RET SAT'] = seaice_retreat19982021[:-2]
#dataframe_gerlache['SEAICE DUR SAT'] = seaice_duration_19982021[:-2]
dataframe_gerlache['WSpeed Mean'] = windspeed_summermeans19982021
#dataframe_gerlache['WSpeed STD'] = windspeed_summerstds19982021
dataframe_gerlache['WDir Mean'] = winddir_summermeans19982021
#dataframe_gerlache['WDir STD'] = winddir_summerstds19982021
dataframe_gerlache['MEI Mean'] = mei_summermeans19982021[:-2]
#dataframe_gerlache['MEI STD'] = mei_summerstds19982021[:-2]
dataframe_gerlache['SAM Mean'] = sam_summermeans19982021[:-2]
#dataframe_gerlache['SAM STD'] = sam_summerstds19982021[:-2]
#dataframe_gerlache['SEAICE ADV PALMER'] = seaice_advanceday.values[18:-2]
#dataframe_gerlache['SEAICE RET PALMER'] = seaice_retreatday.values[18:-2]
#dataframe_gerlache['SEAICE DUR PALMER'] = seaice_duration.values[18:-2]
#dataframe_gerlache['SEAICE EXT PALMER'] = seaice_extent.values[18:-2]
#dataframe_gerlache['B Init'] = b_init[:-2]
#dataframe_gerlache['B Term'] = b_term[:-2]
#dataframe_gerlache['B Peak'] = b_peak[:-2]
#dataframe_gerlache['B Dur'] = b_dur[:-2]
#dataframe_gerlache['B Area'] = b_area[:-2]
#dataframe_gerlache['Chla Max'] = chl_max[:-2]
#%%
## Plot Correlation Matrix
corr = dataframe_gerlache.corr()
mask = np.triu(np.ones_like(corr, dtype=bool))
cmap = sns.diverging_palette(230, 20, as_cmap=True)
sns.heatmap(corr, annot=True, mask = mask, cmap=cmocean.cm.balance, vmin=-1, vmax=1)
#plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\randomforests\\gerlache\\annual\\')
graphs_dir = 'gerlache.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Run model
...
dataframe_all = dataframe_gerlache.dropna()
...
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\randomforests\\gerlache\\annual')
currentmodel_permut = pd.read_csv('chlmean_permutation_gerlache.csv', sep=";")
# Load sardine data
...
graphs_dir = 'gerlache_randomforestresults.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_randomforest_SST.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_chl19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SST
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_sst19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEAICE CONC
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaice19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# PAR
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_par19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEA ICE ADVANCE
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceadvance19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEA ICE RETREAT
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceretreat19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEA ICE DURATION
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceduration19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# WIND SPEED
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_windspeed19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# WIND DIRECTION
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_winddirection19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# MEI
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_mei19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SAM
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_sam19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# BLOOM INIT
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_bloominit19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# BLOOM TERM
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_bloomterm19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# BLOOM DUR
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_bloomdur19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# BLOOM AREA
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_bloomarea19982021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceadvancepalmer19802021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEA ICE RETREAT
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceretreat19802021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEA ICE DURATION
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaiceduration19802021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SST 1982-2021
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_sst19832021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
# SEAICE CONC
fig, axs = plt.subplots(1, 1, figsize=(11,4))
...
plt.tight_layout()
#os.chdir('C:\\Users\\afons\\Documents\\artigos\\sardine-2021\\analyses\\Random Forests\\NW')
graphs_dir = 'gerlache_seaice19832021_sepaprmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()