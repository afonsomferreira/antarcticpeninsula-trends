...
plt.plot(np.arange(0, 301), weddell_monthly_19972021_movmean, color = [43/256, 131/256, 186/256, 1], linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 301),weddell_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\weddell_par.png'
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\weddell_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\weddell_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 301), gerlache_monthly_19972021_movmean, color = [215/256, 25/256, 28/256, 1], linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 301),gerlache_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\gerlache_par.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\gerlache_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\gerlache_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 301), oceanic_monthly_19972021_movmean, color = '#d09c26', linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 301),oceanic_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\oceanic_par.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\oceanic_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\oceanic_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 301), bransfield_monthly_19972021_movmean, color = '#9800cb', linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 301),bransfield_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\bransfield_par.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\bransfield_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('PAR (E m$^{-2}$ d$^{-1}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\bransfield_par_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()