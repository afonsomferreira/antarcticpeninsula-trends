...
chl_wedo_df = pd.Series(data=chl_wedo, index=time_date)
chl_wedo_df_monthly = chl_wedo_df.resample('M').mean()
chl_wedo_monthly = chl_wedo_df_monthly.values
chl_wedo_monthly_timedate = chl_wedo_df_monthly.index
## Load SST
...
sst_wedo = sst[clusters == 5,:]
sst_wedo = np.nanmean(sst_wedo,0)
sst_wedo_df = pd.Series(data=sst_wedo, index=time_date_sst)
sst_wedo_df_monthly = sst_wedo_df.resample('M').mean()
sst_wedo_monthly = sst_wedo_df_monthly.values
sst_wedo_monthly_timedate = sst_wedo_df_monthly.index
## Load Sea Ice
...
seaice_wedo = seaice[clusters == 5,:]
seaice_wedo = np.nanmean(seaice_wedo,0)
seaice_wedo_df = pd.Series(data=seaice_wedo, index=time_date_seaice)
seaice_wedo_df_monthly = seaice_wedo_df.resample('M').mean()
seaice_wedo_monthly = seaice_wedo_df_monthly.values
seaice_wedo_monthly_timedate = seaice_wedo_df_monthly.index
## Load PAR
...
par_wedo_df_monthly = par_wedo_df.resample('M').mean()
par_wedo_monthly = par_wedo_df_monthly.values
par_wedo_monthly_timedate = par_wedo_df_monthly.index
## Load MEI
...
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(sst_wedo_monthly_timedate, sst_wedo_monthly, c='r', label='SST')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sst_wedo_monthly[12:], chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_wedo_monthly[4:][~np.isnan(chl_wedo_monthly[4:])], sst_wedo_monthly[12:][~np.isnan(chl_wedo_monthly[4:])])
#%% Chl-a vs Sea Ice (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(seaice_wedo_monthly_timedate, seaice_wedo_monthly, c='r', label='Sea Ice')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(seaice_wedo_monthly[12:], chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_wedo_monthly[4:][~np.isnan(chl_wedo_monthly[4:])], seaice_wedo_monthly[12:][~np.isnan(chl_wedo_monthly[4:])])
#%% Chl-a vs PAR (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(par_wedo_monthly_timedate, par_wedo_monthly, c='r', label='PAR')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(par_wedo_monthly[4:-9], chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedo_monthly[4:]), np.isnan(par_wedo_monthly[4:-9])))     
indices = np.array(indices)
x = chl_wedo_monthly[4:][indices]
y = par_wedo_monthly[4:-9][indices]
...
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedo_monthly_timedate[4:], sam_monthly, c='r', label='SAM')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sam_monthly, chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedo_monthly[4:]), np.isnan(sam_monthly)))     
indices = np.array(indices)
x = chl_wedo_monthly[4:][indices]
...
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedo_monthly_timedate[4:], mei_monthly, c='r', label='SAM')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(mei_monthly, chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedo_monthly[4:]), np.isnan(mei_monthly)))     
indices = np.array(indices)
x = chl_wedo_monthly[4:][indices]
...
axs.plot(chl_wedo_monthly_timedate, chl_wedo_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedo_monthly_timedate[4:], sunspots_monthly, c='r', label='Sunspots')
axs.set_xlim(chl_wedo_monthly_timedate[0],chl_wedo_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sunspots_monthly, chl_wedo_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedo_monthly[4:]), np.isnan(sunspots_monthly)))     
indices = np.array(indices)
x = chl_wedo_monthly[4:][indices]
...
for i in np.arange(1998, 2022):
    yeartemp_sep = chl_wedo[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = chl_wedo[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = chl_wedo[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = chl_wedo[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = chl_wedo[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = chl_wedo[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = chl_wedo[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = chl_wedo[(time_date_years == i) & (time_date_months == 4)]
...
for i in np.arange(1998, 2022):
    yeartemp_sep = sst_wedo[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = sst_wedo[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = sst_wedo[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = sst_wedo[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = sst_wedo[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = sst_wedo[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = sst_wedo[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = sst_wedo[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    yeartemp_decfeb = np.nanmean(np.hstack((yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb)))
...
for i in np.arange(1998, 2022):
    yeartemp_sep = seaice_wedo[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = seaice_wedo[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = seaice_wedo[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = seaice_wedo[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = seaice_wedo[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = seaice_wedo[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = seaice_wedo[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = seaice_wedo[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in np.arange(1998, 2022):
    yeartemp_sep = par_wedo[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = par_wedo[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = par_wedo[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = par_wedo[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = par_wedo[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = par_wedo[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = par_wedo[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = par_wedo[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    yeartemp_decfeb = np.nanmean(np.hstack((yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb)))    
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(chl_wedo[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(sst_wedo[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(seaice_wedo[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(par_wedo[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(chl_wedo[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(sst_wedo[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(seaice_wedo[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(par_wedo[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(chl_wedo[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(sst_wedo[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(seaice_wedo[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(par_wedo[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_nov[~np.isnan(par_nov)], par_nov[~np.isnan(par_nov)])
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(chl_wedo[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(sst_wedo[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(seaice_wedo[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(par_wedo[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(chl_wedo[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(sst_wedo[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(seaice_wedo[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(par_wedo[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(chl_wedo[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(sst_wedo[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(seaice_wedo[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(par_wedo[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(chl_wedo[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(sst_wedo[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(seaice_wedo[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(par_wedo[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(chl_wedo[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(sst_wedo[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(seaice_wedo[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(par_wedo[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_apr[~np.isnan(par_apr)], par_apr[~np.isnan(par_apr)])
#%% Chl-a vs SAM (April)
years_chl = np.arange(1998, 2022)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
