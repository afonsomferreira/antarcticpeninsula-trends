...
graphs_dir = 'gerlache_insituchlhplc_janfebmean.png'
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janmarmean.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Plot Jan-Feb (with bloom and without removing data)
(_, caps, _) = plt.errorbar(np.arange(1997, 2019), chlinsitu_janfeb19812021, yerr=chlinsitustd_janfeb19982021, capsize=3, elinewidth=1, linestyle='None', marker='o', c='k')
[slope,intercept,r,pval,_] = stats.linregress(np.arange(1997, 2019)[~np.isnan(chlinsitu_janfeb19812021)], chlinsitu_janfeb19812021[~np.isnan(chlinsitu_janfeb19812021)])
plt.plot(np.arange(1997,2019), np.arange(1997,2019)*slope+intercept, linestyle='--', c='b', alpha=0.5)
plt.text(1998, 10, f"R={r:.2f}", fontsize=14)
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janfebmean_allyears.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% (with bloom)
(_, caps, _) = plt.errorbar(np.arange(1997, 2019), chlinsitu_janmar19812021, yerr=chlinsitustd_janmar19982021, capsize=3, elinewidth=1, linestyle='None', marker='o', c='k')
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janmarmean_allyears.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%% Plot Jan-Feb
(_, caps, _) = plt.errorbar(np.arange(1997, 2019), chlinsitu_janfeb19812021, yerr=chlinsitustd_janfeb19982021, capsize=3, elinewidth=1, linestyle='None', marker='o', c='k')
[slope,intercept,r,pval,_] = stats.linregress(np.arange(1997, 2019)[~np.isnan(chlinsitu_janfeb19812021)], chlinsitu_janfeb19812021[~np.isnan(chlinsitu_janfeb19812021)])
plt.plot(np.arange(1997,2019), np.arange(1997,2019)*slope+intercept, linestyle='--', c='b', alpha=0.5)
plt.text(1998, 7, f"R={r:.2f}", fontsize=14)
plt.text(1998, 6.5, f"p-val={pval:.2f}", fontsize=14)
plt.xlabel('Years', fontsize=14)
plt.ylabel('Chla', fontsize=14)
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janfebmean_without2016bloom.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%%
(_, caps, _) = plt.errorbar(np.arange(1997, 2019), chlinsitu_janmar19812021, yerr=chlinsitustd_janmar19982021, capsize=3, elinewidth=1, linestyle='None', marker='o', c='k')
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janmarmean_without2016bloom.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%%
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janfeb_counts_without2016bloom.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
...
plt.tight_layout()
os.chdir('C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\')
graphs_dir = 'gerlache_insituchlhplc_janmar_counts_without2016bloom.png'
plt.savefig(graphs_dir, format='png', bbox_inches='tight', dpi=300)
plt.close()
#%%
