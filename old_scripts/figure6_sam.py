...
plt.plot(sam_pd_monthly_cumsum)
#%% Calculate trends
# full period
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529), sam_pd_monthly)
# 1979-1995
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[:192], sam_pd_monthly[:192])
# 1995-2005
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[192:312], sam_pd_monthly[192:312])
# 2005-2022
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[312:], sam_pd_monthly[312:])
# 2006-2022
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[324:], sam_pd_monthly[324:])
# 2007-2022
slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[336:], sam_pd_monthly[336:])
# 2008-2022
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[348:], sam_pd_monthly[348:])
# 2009-2022
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[360:], sam_pd_monthly[360:])
# 2010-2022
#slope, intercept, rval, pval, _ = stats.linregress(np.arange(529)[372:], sam_pd_monthly[372:])



#%%
fig, axs = plt.subplots(1, 1, figsize=(9,3))
axs.plot(np.arange(529), sam_pd_monthly.values, 'gray', linewidth=2, alpha=0.4, label='Monthly SAM')
...
plt.axvline(372,c='k', linewidth=2, alpha=.7, linestyle='-')
...
plt.xticks(ticks=[12, 72, 132, 192, 252, 312, 372, 432, 492], labels=['1980', '1985', '1990', '1995', '2000',
                                              '2005', '2010', '2015', '2020'])
fig.legend(loc="upper right", bbox_to_anchor=(.85,1.151), bbox_transform=axs.transAxes, ncol=4, fontsize=10)
