...
yearlyaveragecycles = np.empty((220, 480, 365))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_10km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
