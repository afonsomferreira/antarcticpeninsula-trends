...
### Load data 1998-2020
fh = np.load('chloc4so_19972021_25km.npz', allow_pickle=True)
lat = fh['lat']
lon = fh['lon']
chl = fh['chl']
...
yearlyaveragecycles = np.empty((88, 192, 12))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_month_25km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
