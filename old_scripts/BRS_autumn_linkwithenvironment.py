...
for i in np.arange(1998, 2022):
    yeartemp_mar = chl_brs[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = chl_brs[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_marapr = np.hstack((yeartemp_mar, yeartemp_apr))
    yeartemp_marapr = np.count_nonzero(~np.isnan(yeartemp_marapr))
    if i == 1998:
        chl_aprmar = yeartemp_marapr
    else:
        chl_aprmar = np.hstack((chl_aprmar, yeartemp_marapr))


chl_aprmar_count = chl_aprmar.astype(float)
chl_aprmar_count[12] = np.nan

plt.scatter(np.arange(1998, 2022), chl_aprmar_count)


slope, _, rvalue, pvalue, _ = stats.linregress(np.arange(1998, 2022), chl_aprmar_count)
...
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(sst_brs_monthly_timedate, sst_brs_monthly, c='r', label='SST')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_sst_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sst_brs_monthly[12:], chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('SST (°C)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_sst_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_brs_monthly[4:][~np.isnan(chl_brs_monthly[4:])], sst_brs_monthly[12:][~np.isnan(chl_brs_monthly[4:])])
#%% Chl-a vs Sea Ice (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(seaice_brs_monthly_timedate, seaice_brs_monthly, c='r', label='Sea Ice')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_seaice_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(seaice_brs_monthly[12:], chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('Sea Ice (%)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_seaice_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_brs_monthly[4:][~np.isnan(chl_brs_monthly[4:])], seaice_brs_monthly[12:][~np.isnan(chl_brs_monthly[4:])])
#%% Chl-a vs PAR (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(par_brs_monthly_timedate, par_brs_monthly, c='r', label='PAR')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_par_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(par_brs_monthly[4:-9], chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('PAR', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_par_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_brs_monthly[4:]), np.isnan(par_brs_monthly[4:-9])))     
indices = np.array(indices)
x = chl_brs_monthly[4:][indices]
y = par_brs_monthly[4:-9][indices]
...
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_brs_monthly_timedate[4:], sam_monthly, c='r', label='SAM')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_SAM_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sam_monthly, chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('SAM', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_SAM_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_brs_monthly[4:]), np.isnan(sam_monthly)))     
indices = np.array(indices)
x = chl_brs_monthly[4:][indices]
...
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_brs_monthly_timedate[4:], mei_monthly, c='r', label='SAM')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_MEI_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(mei_monthly, chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('MEI', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_MEI_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_brs_monthly[4:]), np.isnan(mei_monthly)))     
indices = np.array(indices)
x = chl_brs_monthly[4:][indices]
...
axs.plot(chl_brs_monthly_timedate, chl_brs_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_brs_monthly_timedate[4:], sunspots_monthly, c='r', label='Sunspots')
axs.set_xlim(chl_brs_monthly_timedate[0],chl_brs_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_sunspots_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sunspots_monthly, chl_brs_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
axs.set_xlabel('Sunspots', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_monthly\\chla_sunspots_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_brs_monthly[4:]), np.isnan(sunspots_monthly)))     
indices = np.array(indices)
x = chl_brs_monthly[4:][indices]
...
for i in np.arange(1998, 2022):
    ...
    yeartemp_nov = chl_brs[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = chl_brs[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = chl_brs[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = chl_brs[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = chl_brs[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = chl_brs[(time_date_years == i) & (time_date_months == 4)]
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = sst_brs[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = sst_brs[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = sst_brs[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = sst_brs[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = sst_brs[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = sst_brs[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = sst_brs[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = sst_brs[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = seaice_brs[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = seaice_brs[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = seaice_brs[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = seaice_brs[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = seaice_brs[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = seaice_brs[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = seaice_brs[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = seaice_brs[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = par_brs[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = par_brs[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = par_brs[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = par_brs[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = par_brs[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = par_brs[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = par_brs[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = par_brs[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
axs2.set_ylabel('SST (°C)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sst_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SST (°C)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sst_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice (%)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaice_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice (%)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaice_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('PAR', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_par_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('PAR', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_par_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('SAM', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SAM', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_lag3_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_lag3_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_lag6_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sam_lag6_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('MEI', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('MEI', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_lag3_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_lag3_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_lag6_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_mei_lag6_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceadv_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceadv_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceret_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceret_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaicedur_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaicedur_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceextent_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_seaiceextent_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sunspots', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sunspots_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sunspots', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_sepapr\\chla_sunspots_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('SST (°C)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sst_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SST (°C)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sst_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice (%)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaice_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice (%)', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaice_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('PAR', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_par_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('PAR', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_par_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('SAM', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SAM', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('SAM LAG3', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_lag3_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SAM LAG3', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_lag3_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('SAM LAG6', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_lag6_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('SAM LAG6', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sam_lag6_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('MEI', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('MEI', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('MEI LAG3', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_lag3_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('MEI LAG3', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_lag3_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('MEI LAG6', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_lag6_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('MEI LAG6', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_mei_lag6_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice Adv', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceadv_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice Adv', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceadv_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice Ret', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceret_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice Ret', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceret_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice Dur', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaicedur_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice Dur', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaicedur_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sea Ice Ext', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceextent_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sea Ice Ext', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_seaiceextent_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
axs2.set_ylabel('Sunspots', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sunspots_line.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
...
axs.set_xlabel('Sunspots', fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\timeseries_comparisons\\chla_decfeb\\chla_sunspots_scatter.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
