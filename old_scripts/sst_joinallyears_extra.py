...
def serial_date_to_string(srl_no):
    ...
    return new_date
os.chdir('C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\resources\\sst-seaice\\ostia\\extra\\')
### Load and join data
files = os.listdir()
for i in files:
    print(i)
...
time_date_20172021 = time_date[8036:]
time_date_19972011 = time_date[:5478]
time_date_20122016 = time_date[5843:7670]
sst_20172021 = sst[:,:,8036:]
sst_19972011 = sst[:,:,:5478]
sst_20122016 = sst[:,:,5843:7670]
seaice_20172021 = seaice[:,:,8036:]
seaice_19972011 = seaice[:,:,:5478]
seaice_20122016 = seaice[:,:,5843:7670]
time_date = np.hstack((time_date_19972011, time_date_20122016, time_date_20172021))
sst = np.dstack((sst_19972011, sst_20122016, sst_20172021))
seaice = np.dstack((seaice_19972011, seaice_20122016, seaice_20172021))


np.savez_compressed('sst-seaice_19972021_extra', #sst=sst, #seaice=seaice,
