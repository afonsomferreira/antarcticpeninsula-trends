...
yearlyaveragecycles = np.empty((88, 192, 365))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_25km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
