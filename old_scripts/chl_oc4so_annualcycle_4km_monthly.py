...
yearlyaveragecycles = np.empty((529, 1153, 12))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_month', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
