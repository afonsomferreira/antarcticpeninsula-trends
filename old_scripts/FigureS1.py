...
#%% Prepare data for plot BRS BTERM
brs_bterm = [20,29,27,25,30,26,29,27,26,27,25,28,32,31,30,30,31,30,29,26,32,30,31,29]
brs_bterm_rsi = 0.61853 #2010
brs_bterm_meanbefore2010 = 26.797
brs_bterm_meanafter2010 = 30.083
plt.figure(figsize=(5,5))
plt.plot(np.arange(1998, 2022), brs_bterm, c=[0,0,0,0.2], marker='o', markerfacecolor=[0,0,0,1], markersize=5, label='BRS BTerm.')
plt.plot(np.arange(1998, 2022), np.hstack((np.repeat(brs_bterm_meanbefore2010,12),
                                           np.repeat(brs_bterm_meanafter2010,12))), c='#A50021', linewidth=3, label='Huber weighted means')
plt.xlabel('Years', fontsize=14)
plt.ylabel('Bloom Termination (Week)', fontsize=14)
plt.legend(loc=0, fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\BRS_bterm_FigS1.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%%
ges_chlmarch = [1.22004,0.782359,1.4686,2.01014,1.27958,0.648301,1.73229,2.02635,
                2.07224,2.55572,0.933078,1.58944, np.nan, 2.86933,1.53088,2.40324,2.17831,
                2.45852,3.36489,2.54765,1.4047,2.06502,2.00766,1.32891]
ges_chlmarch_rsi = 0.22937 #2010
ges_chlmarch_pval = 0.015214
ges_chlmarch_meanbefore2011 = 1.5265
ges_chlmarch_meanafter2011 = 2.1963
plt.figure(figsize=(5,5))
plt.plot(np.arange(1998, 2022), ges_chlmarch, c=[0,0,0,0.2], marker='o', markerfacecolor=[0,0,0,1], markersize=5, label='GES March Chl-a')
plt.plot(np.arange(1998, 2022), np.hstack((np.repeat(ges_chlmarch_meanbefore2011,13),
                                           np.repeat(ges_chlmarch_meanafter2011,11))), c='#A50021', linewidth=3, label='Huber weighted means')
plt.xlabel('Years', fontsize=14)
plt.ylabel('GES March mean Chl-a (mg m$^{-3}$)', fontsize=14)
plt.legend(loc=0, fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\GES_marchchl_FigS1.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%%
brs_chlapril = [0.46695,0.454406,0.581375,0.450185,0.962069,0.465427,0.803997,
                0.470802,0.90608,0.773984,0.764189,0.884792,1.1133,1.01152,
                1.24483,0.848632,1.08717,0.888538,1.19701,0.962885,1.47327,
                0.684422,0.855756,1.02058]
brs_chlapril_rsi = 1.055246174 #2009
brs_chlapril_pval = 0.000172538490377374
brs_chlapril_meanbefore2011 = 0.645405818181818
brs_chlapril_meanafter2011 = 1.01794015529933
plt.figure(figsize=(5,5))
plt.plot(np.arange(1998, 2022), brs_chlapril, c=[0,0,0,0.2], marker='o', markerfacecolor=[0,0,0,1], markersize=5, label='GES April Chl-a')
plt.plot(np.arange(1998, 2022), np.hstack((np.repeat(brs_chlapril_meanbefore2011,11),
                                           np.repeat(brs_chlapril_meanafter2011,13))), c='#A50021', linewidth=3, label='Huber weighted means')
plt.xlabel('Years', fontsize=14)
plt.ylabel('BRS April mean Chl-a (mg m$^{-3}$)', fontsize=14)
plt.legend(loc=0, fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\BRS_aprilchl_FigS1.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%%
brs_chlmarch = [0.567094,0.8509,0.999958,0.711,0.925776,0.532627,0.895776,
                0.993654,1.01714,0.831615,0.637774,1.09041,np.nan, 1.77021,1.87472,
                1.4321,1.06057,1.24437,1.5561,0.617912,2.11892,1.49682,
                0.866164,1.21257]
brs_chlmarch_rsi = 0.478681806165062 #2009
brs_chlmarch_pval = 0.00219213076446742
brs_chlmarch_meanbefore2011 = 0.837810333333333
brs_chlmarch_meanafter2011 = 1.38640509090909
plt.figure(figsize=(5,5))
plt.plot(np.arange(1998, 2022), brs_chlmarch, c=[0,0,0,0.2], marker='o', markerfacecolor=[0,0,0,1], markersize=5, label='GES March Chl-a')
plt.plot(np.arange(1998, 2022), np.hstack((np.repeat(brs_chlmarch_meanbefore2011,13),
                                           np.repeat(brs_chlmarch_meanafter2011,11))), c='#A50021', linewidth=3, label='Huber weighted means')
plt.xlabel('Years', fontsize=14)
plt.ylabel('BRS March mean Chl-a (mg m$^{-3}$)', fontsize=14)
plt.legend(loc=0, fontsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\BRS_marchchl_FigS1.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
chl_wedi_df = pd.Series(data=chl_wedi, index=time_date)
chl_wedi_df_monthly = chl_wedi_df.resample('M').mean()
chl_wedi_monthly = chl_wedi_df_monthly.values
chl_wedi_monthly_timedate = chl_wedi_df_monthly.index
## Load SST
...
sst_wedi = sst[clusters == 1,:]
sst_wedi = np.nanmean(sst_wedi,0)
sst_wedi_df = pd.Series(data=sst_wedi, index=time_date_sst)
sst_wedi_df_monthly = sst_wedi_df.resample('M').mean()
sst_wedi_monthly = sst_wedi_df_monthly.values
sst_wedi_monthly_timedate = sst_wedi_df_monthly.index
## Load Sea Ice
...
seaice_wedi = seaice[clusters == 1,:]
seaice_wedi = np.nanmean(seaice_wedi,0)
seaice_wedi_df = pd.Series(data=seaice_wedi, index=time_date_seaice)
seaice_wedi_df_monthly = seaice_wedi_df.resample('M').mean()
seaice_wedi_monthly = seaice_wedi_df_monthly.values
seaice_wedi_monthly_timedate = seaice_wedi_df_monthly.index
## Load PAR
...
par_wedi_df_monthly = par_wedi_df.resample('M').mean()
par_wedi_monthly = par_wedi_df_monthly.values
par_wedi_monthly_timedate = par_wedi_df_monthly.index
## Load MEI
...
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(sst_wedi_monthly_timedate, sst_wedi_monthly, c='r', label='SST')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sst_wedi_monthly[12:], chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_wedi_monthly[4:][~np.isnan(chl_wedi_monthly[4:])], sst_wedi_monthly[12:][~np.isnan(chl_wedi_monthly[4:])])
#%% Chl-a vs Sea Ice (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(seaice_wedi_monthly_timedate, seaice_wedi_monthly, c='r', label='Sea Ice')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(seaice_wedi_monthly[12:], chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
slope, intercept, rval, pval, _ = stats.linregress(chl_wedi_monthly[4:][~np.isnan(chl_wedi_monthly[4:])], seaice_wedi_monthly[12:][~np.isnan(chl_wedi_monthly[4:])])
#%% Chl-a vs PAR (M)
# Plot side by side
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(par_wedi_monthly_timedate, par_wedi_monthly, c='r', label='PAR')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(par_wedi_monthly[4:-9], chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedi_monthly[4:]), np.isnan(par_wedi_monthly[4:-9])))     
indices = np.array(indices)
x = chl_wedi_monthly[4:][indices]
y = par_wedi_monthly[4:-9][indices]
...
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedi_monthly_timedate[4:], sam_monthly, c='r', label='SAM')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sam_monthly, chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedi_monthly[4:]), np.isnan(sam_monthly)))     
indices = np.array(indices)
x = chl_wedi_monthly[4:][indices]
...
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedi_monthly_timedate[4:], mei_monthly, c='r', label='SAM')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(mei_monthly, chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedi_monthly[4:]), np.isnan(mei_monthly)))     
indices = np.array(indices)
x = chl_wedi_monthly[4:][indices]
...
axs.plot(chl_wedi_monthly_timedate, chl_wedi_monthly, c='g', label='Chla')
axs2 = axs.twinx()
axs2.plot(chl_wedi_monthly_timedate[4:], sunspots_monthly, c='r', label='Sunspots')
axs.set_xlim(chl_wedi_monthly_timedate[0],chl_wedi_monthly_timedate[-1])
axs.yaxis.label.set_color('k')
axs.tick_params(axis='y', colors='k')
axs.spines['left'].set_color('k')
...
# Plot Correlation
fig, axs = plt.subplots(1, 1, figsize=(12,6))
axs.scatter(sunspots_monthly, chl_wedi_monthly[4:])
axs.set_ylabel('Chla (mg/m3)', fontsize=12)
...
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
indices = np.logical_not(np.logical_or(np.isnan(chl_wedi_monthly[4:]), np.isnan(sunspots_monthly)))     
indices = np.array(indices)
x = chl_wedi_monthly[4:][indices]
...
for i in np.arange(1998, 2022):
    yeartemp_sep = chl_wedi[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = chl_wedi[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = chl_wedi[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = chl_wedi[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = chl_wedi[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = chl_wedi[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = chl_wedi[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = chl_wedi[(time_date_years == i) & (time_date_months == 4)]
...
for i in np.arange(1998, 2022):
    yeartemp_sep = sst_wedi[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = sst_wedi[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = sst_wedi[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = sst_wedi[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = sst_wedi[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = sst_wedi[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = sst_wedi[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = sst_wedi[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in np.arange(1998, 2022):
    yeartemp_sep = seaice_wedi[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = seaice_wedi[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = seaice_wedi[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = seaice_wedi[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = seaice_wedi[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = seaice_wedi[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = seaice_wedi[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = seaice_wedi[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in np.arange(1998, 2022):
    yeartemp_sep = par_wedi[(time_date_years == i-1) & (time_date_months == 9)]
    yeartemp_oct = par_wedi[(time_date_years == i-1) & (time_date_months == 10)]
    yeartemp_nov = par_wedi[(time_date_years == i-1) & (time_date_months == 11)]
    yeartemp_dec = par_wedi[(time_date_years == i-1) & (time_date_months == 12)]
    yeartemp_jan = par_wedi[(time_date_years == i) & (time_date_months == 1)]
    yeartemp_feb = par_wedi[(time_date_years == i) & (time_date_months == 2)]
    yeartemp_mar = par_wedi[(time_date_years == i) & (time_date_months == 3)]
    yeartemp_apr = par_wedi[(time_date_years == i) & (time_date_months == 4)]
    yeartemp_sepapr = np.nanmean(np.hstack((yeartemp_sep, yeartemp_oct, yeartemp_nov, yeartemp_dec,
                                                     yeartemp_jan, yeartemp_feb, yeartemp_mar, yeartemp_apr)))
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(chl_wedi[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(sst_wedi[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(seaice_wedi[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_sep = np.nanmean(par_wedi[(time_date_years == i-1) & (time_date_months == 9)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(chl_wedi[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(sst_wedi[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(seaice_wedi[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_oct = np.nanmean(par_wedi[(time_date_years == i-1) & (time_date_months == 10)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(chl_wedi[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(sst_wedi[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(seaice_wedi[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_nov = np.nanmean(par_wedi[(time_date_years == i-1) & (time_date_months == 11)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(chl_wedi[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(sst_wedi[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(seaice_wedi[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_dec = np.nanmean(par_wedi[(time_date_years == i-1) & (time_date_months == 12)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(chl_wedi[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(sst_wedi[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(seaice_wedi[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_jan = np.nanmean(par_wedi[(time_date_years == i) & (time_date_months == 1)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(chl_wedi[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(sst_wedi[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(seaice_wedi[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_feb = np.nanmean(par_wedi[(time_date_years == i) & (time_date_months == 2)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(chl_wedi[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(sst_wedi[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(seaice_wedi[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_mar = np.nanmean(par_wedi[(time_date_years == i) & (time_date_months == 3)])
    if i == 1998:
...
for i in range(0, len(time_date)):
    ...
    time_date_months[i] = time_date[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(chl_wedi[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_sst)):
    ...
    time_date_months[i] = time_date_sst[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(sst_wedi[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_seaice)):
    ...
    time_date_months[i] = time_date_seaice[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(seaice_wedi[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
...
for i in range(0, len(time_date_par)):
    ...
    time_date_months[i] = time_date_par[i].month
for i in np.arange(1998, 2022):
    yeartemp_apr = np.nanmean(par_wedi[(time_date_years == i) & (time_date_months == 4)])
    if i == 1998:
