...
yearlyaveragecycles = np.empty((220, 480, 12))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_month_10km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
