...
np.savez_compressed('phenology_weddell_10km', b_init=wed_chl_init,b_term=wed_chl_term,
...
np.savez_compressed('phenology_gerlache_10km', b_init=ger_chl_init,b_term=ger_chl_term,
...
np.savez_compressed('phenology_oceanic_10km', b_init=oce_chl_init,b_term=oce_chl_term,
...
np.savez_compressed('phenology_bransfield_10km', b_init=bra_chl_init,b_term=bra_chl_term,
...
sns.heatmap([wed_chl_init[1:], wed_chl_peak[1:], wed_chl_term[1:],
             ...
             oce_chl_init[1:], oce_chl_peak[1:], oce_chl_term[1:]], square=True, annot=True,
