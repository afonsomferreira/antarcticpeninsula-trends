...
np.savez_compressed('ges_trends_glmd', ges_b_term=ges_b_term, ges_mar=ges_mar)
...
#%% Calculate correlations between chl and SAM
stats.spearmanr(ges_mar, sam_pd_yearly.values[19:-1])


plt.scatter(np.arange(1998, 2023), ges_mar)
plt.scatter(np.arange(1998, 2023), sam_pd_yearly.values[19:-1])
