...
yearlyaveragecycles = np.empty((147, 320, 12))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_month_15km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
