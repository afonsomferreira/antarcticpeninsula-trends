...
f1 = map.pcolormesh(lon_new, lat_new, np.log10(chl_reducedresolution_climatology), transform=ccrs.PlateCarree(), shading='flat', vmin=np.log10(0.01),
                    vmax=np.log10(10), cmap=cmocean.cm.algae)
plt.scatter(lon_new[:-1]+0.125,lat_new[:-1]+0.125, color = 'blue')
