...
#%% seaice - Separate betweeen 2001-2010 and 2011-2020
def setBoxColors(bp):
...
spring_boxplot = [ges_spring_seaice20012010[~np.isnan(ges_spring_seaice20012010)],  ges_spring_seaice20112020[~np.isnan(ges_spring_seaice20112020)]]
summer_boxplot = [ges_summer_seaice20012010[~np.isnan(ges_summer_seaice20012010)],  ges_summer_seaice20112020[~np.isnan(ges_summer_seaice20112020)]]
autumn_boxplot = [ges_autumn_seaice20012010[~np.isnan(ges_autumn_seaice20012010)],  ges_autumn_seaice20112020[~np.isnan(ges_autumn_seaice20112020)]]
...
plt.xticks(ticks=[1.5, 4.5, 7.5], labels=['SPRING', 'SUMMER', 'AUTUMN'],
           fontsize=12)
plt.ylabel('seaice', fontsize=14)
plt.tick_params(axis='x', labelsize=12)
plt.tick_params(axis='y', labelsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\20012010-20112020\\ges_seaice.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Calculate statistically significant differences
stats.mannwhitneyu(ges_spring_seaice20012010, ges_spring_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(ges_summer_seaice20012010, ges_summer_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(ges_autumn_seaice20012010, ges_autumn_seaice20112020, nan_policy = 'omit') # **
...
spring_boxplot = [weds_spring_seaice20012010[~np.isnan(weds_spring_seaice20012010)],  weds_spring_seaice20112020[~np.isnan(weds_spring_seaice20112020)]]
summer_boxplot = [weds_summer_seaice20012010[~np.isnan(weds_summer_seaice20012010)],  weds_summer_seaice20112020[~np.isnan(weds_summer_seaice20112020)]]
autumn_boxplot = [weds_autumn_seaice20012010[~np.isnan(weds_autumn_seaice20012010)],  weds_autumn_seaice20112020[~np.isnan(weds_autumn_seaice20112020)]]
...
plt.tick_params(axis='y', labelsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\20012010-20112020\\weds_seaice.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Calculate statistically significant differences
stats.mannwhitneyu(weds_spring_seaice20012010, weds_spring_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(weds_summer_seaice20012010, weds_summer_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(weds_autumn_seaice20012010, weds_autumn_seaice20112020, nan_policy = 'omit') # **
...
spring_boxplot = [brs_spring_seaice20012010[~np.isnan(brs_spring_seaice20012010)],  brs_spring_seaice20112020[~np.isnan(brs_spring_seaice20112020)]]
summer_boxplot = [brs_summer_seaice20012010[~np.isnan(brs_summer_seaice20012010)],  brs_summer_seaice20112020[~np.isnan(brs_summer_seaice20112020)]]
autumn_boxplot = [brs_autumn_seaice20012010[~np.isnan(brs_autumn_seaice20012010)],  brs_autumn_seaice20112020[~np.isnan(brs_autumn_seaice20112020)]]
...
plt.tick_params(axis='y', labelsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\20012010-20112020\\brs_seaice.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Calculate statistically significant differences
stats.mannwhitneyu(brs_spring_seaice20012010, brs_spring_seaice20112020, nan_policy = 'omit') #
stats.mannwhitneyu(brs_summer_seaice20012010, brs_summer_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(brs_autumn_seaice20012010, brs_autumn_seaice20112020, nan_policy = 'omit') #
...
spring_boxplot = [wedn_spring_seaice20012010[~np.isnan(wedn_spring_seaice20012010)],  wedn_spring_seaice20112020[~np.isnan(wedn_spring_seaice20112020)]]
summer_boxplot = [wedn_summer_seaice20012010[~np.isnan(wedn_summer_seaice20012010)],  wedn_summer_seaice20112020[~np.isnan(wedn_summer_seaice20112020)]]
autumn_boxplot = [wedn_autumn_seaice20012010[~np.isnan(wedn_autumn_seaice20012010)],  wedn_autumn_seaice20112020[~np.isnan(wedn_autumn_seaice20112020)]]
...
plt.tick_params(axis='y', labelsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\20012010-20112020\\wedn_seaice.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Calculate statistically significant differences
stats.mannwhitneyu(wedn_spring_seaice20012010, wedn_spring_seaice20112020, nan_policy = 'omit') # ***  
stats.mannwhitneyu(wedn_summer_seaice20012010, wedn_summer_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(wedn_autumn_seaice20012010, wedn_autumn_seaice20112020, nan_policy = 'omit') # ***
...
spring_boxplot = [dra_spring_seaice20012010[~np.isnan(dra_spring_seaice20012010)],  dra_spring_seaice20112020[~np.isnan(dra_spring_seaice20112020)]]
summer_boxplot = [dra_summer_seaice20012010[~np.isnan(dra_summer_seaice20012010)],  dra_summer_seaice20112020[~np.isnan(dra_summer_seaice20112020)]]
autumn_boxplot = [dra_autumn_seaice20012010[~np.isnan(dra_autumn_seaice20012010)],  dra_autumn_seaice20112020[~np.isnan(dra_autumn_seaice20112020)]]
...
plt.tick_params(axis='y', labelsize=12)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\analysis\\20012010-20112020\\dra_seaice.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Calculate statistically significant differences
stats.mannwhitneyu(dra_spring_seaice20012010, dra_spring_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(dra_summer_seaice20012010, dra_summer_seaice20112020, nan_policy = 'omit') # ***
stats.mannwhitneyu(dra_autumn_seaice20012010, dra_autumn_seaice20112020, nan_policy = 'omit') # *
