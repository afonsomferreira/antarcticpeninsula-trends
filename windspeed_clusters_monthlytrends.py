...
#os.chdir('C:\\Users\\afons\\OneDrive - Universidade de Lisboa\\Documents\\artigos\\antarctic-peninsula-trends-2021\\resources\\oc4so_sst\\')
#fh = np.load('antarcticpeninsula_newclusters_parbelow15.npz',allow_pickle = True)
...
stats.linregress(np.arange(1998, 2022)[~np.isnan(ges_apr)], ges_apr[~np.isnan(ges_apr)]) # 
