...
yearlyaveragecycles = np.empty((110, 240, 365))
...
np.savez_compressed('chloc4so_19972021_yearlyaveragecycles_20km', chl_averagecycle=yearlyaveragecycles,time_date=time_date,
                    lat=lat, lon=lon)
