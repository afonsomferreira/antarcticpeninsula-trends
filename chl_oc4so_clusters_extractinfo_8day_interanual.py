...
plt.plot(np.arange(0, 292), weddell_monthly_19972021_movmean, color = [43/256, 131/256, 186/256, 1], linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 292),weddell_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
plt.axhline(np.nanmean(weddell_monthly_19972021), color = 'k', linewidth = 2, linestyle=':', alpha=0.5, zorder=1)


plt.xticks(ticks=[4, 16, 28, 40, 52, 64, 76, 88, 100, 112, 124,
                  136, 148, 160, 172, 184, 196, 208, 220, 232,
                  244, 256, 268, 280, 292], labels=['98', '99', '00', '01', '02', '03', '04', '05', '06', '07',
...
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\weddell_chl.png'
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\weddell_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\weddell_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 292), gerlache_monthly_19972021_movmean, color = [215/256, 25/256, 28/256, 1], linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 292),gerlache_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\gerlache_chl.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\gerlache_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\gerlache_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 292), oceanic_monthly_19972021_movmean, color = '#d09c26', linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 292),oceanic_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\oceanic_chl.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\oceanic_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\oceanic_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
...
plt.plot(np.arange(0, 292), bransfield_monthly_19972021_movmean, color = '#9800cb', linewidth = 2, zorder=2)
plt.scatter(np.arange(0, 292),bransfield_monthly_19972021, color = 'k', alpha=0.2, marker='o', zorder=1)
...
#plt.legend(fontsize=12, loc=2)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\bransfield_chl.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
#%% Boxplot
# Separate data per year
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\seasonal_plots\\bransfield_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()
# Boxplot Interannual
...
plt.ylabel('Chl $a$ (mg m$^{-3}$)', fontsize=14)
plt.tight_layout()
graphs_dir = 'C:\\Users\\afons\\Documents\\artigos\\antarcticpeninsula-trends-2021\\analysis\\interannual_plots\\bransfield_chl_boxplot.png'
plt.savefig(graphs_dir,format = 'png', bbox_inches = 'tight', dpi = 300)
plt.close()